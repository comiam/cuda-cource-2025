...
Каждый поток в блоке загружает один пиксель из глобальной памяти в shared memory. Ее использование сильно ускоряет обработку. После загрузки применяется синхронизация потоков.
