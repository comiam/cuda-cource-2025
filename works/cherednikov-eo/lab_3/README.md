...
### Поддержка PNG (опционально)

Для поддержки PNG формата необходимо скачать библиотеку stb_image (файлы`stb_image.h` и `stb_image_write.h`) и поместить их в папку include

Без этих файлов программа будет работать только с PGM форматом.
